...
Gem::Specification.new do |s|
  ...
  s.authors = ["Educa2".freeze, "Rafael Gaspar".freeze]
  s.date = "2017-01-20"
  s.description = "A gem for making a Multi-Tenant SaaS using Mongoid".freeze
  s.email = "suporte@educa2.com.br".freeze
  s.extra_rdoc_files = [
    "LICENSE.txt",
    "README.rdoc"
  ]
  ...
  s.homepage = "http://github.com/educa2/saasable".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<mongoid>.freeze, [">= 4.0.0"])
